...
#define NUMBER_OF_BUTTONS 22  // number of physical + virtual switches. Note: if higher than 32, change buttonStates to uint64_t! // This also changes it in the WebGUI.
